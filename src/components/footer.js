            ...
            <div class = 'container'>
                <div class = 'row py-5 mt-3'>
                    ...
                    <div class = 'col-md-4'>
                        ...
                        <ul style = {{fontSize: '14px', marginLeft: '0px'}} class = 'list-unstyled text-secondary footer-a'>
                    ...
                    <div class = 'col-md-3'>
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <label for="exampleInputEmail1" style = {{fontSize: '13px'}} class = 'text-white mt-3 mb-3'>Cadastre seu melhor e-mail abaixo!</label>
                                <input style = {{fontSize: '14px'}} type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Digite seu E-mail"></input>
                            </div>
                            <button style = {{background: '#2f2f2f', fontFamily: 'Arial', fontSize: '14px'}} type="submit" class="btn py-2 text-white">Cadastrar</button>
                        </form>
                    </div>

...
class VideoTutorialList extends React.Component{
    render(){
        ...
        return (
            <div>
                ...
                <link href="https://fonts.googleapis.com/css?family=Montserrat|Open+Sans&display=swap" rel="stylesheet"></link>
                    ...
                    {/* HEADER*/}
                    <div class = 'imagem-videosTuto text-white'>
                        <HeaderDicas/>
...
export const VideoTutorialListQuery = graphql`
query VideoTutorialListQuery($skip: Int!, $limit: Int!) {
    allMarkdownRemark(

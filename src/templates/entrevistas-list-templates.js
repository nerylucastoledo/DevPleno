...
class EntrevistasList extends React.Component {
    render() {
        const post = this.props.data
        const { currentPage, numPages } = this.props.pageContext
        const isFirst = currentPage === 1
        const isLast = currentPage === numPages
        const prevPage = currentPage - 1 === 1 ? "/dicas/" : (currentPage - 1).toString()
        ...
        return (
            ...
            <div>
                <div id = "Handss" style = {{fontFamily: "Montserrat"}} class = 'text-white'>
                <HeaderDicas/>
...
export default EntrevistasList
export const pageQuery = graphql`
query entrevistasListQuery($skip: Int!, $limit: Int!) {
    allMarkdownRemark(

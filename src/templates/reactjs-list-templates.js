...
class ReactJSList extends React.Component {
    render() {
        ...
        return (
            ...
            <div>
                <div id = "React" style = {{fontFamily: "Montserrat"}} class = 'text-white'>
                <HeaderDicas/>
...
export default ReactJSList
export const pageQuery = graphql`
query reactListQuery($skip: Int!, $limit: Int!) {
    allMarkdownRemark(
